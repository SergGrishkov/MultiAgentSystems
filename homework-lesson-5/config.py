...
RERANKER_MODEL = "cross-encoder/msmarco-MiniLM-L-6-doc2query-msmarco-MiniLM-L-6-retrieval"
...
4. Always use write_report to save your findings as a Markdown report
